package com.goslinggroup.utilsui;
...
public class PasswordField extends JPasswordField {
    ...
    public PasswordField() {
        ...
        eye = new ImageIcon(getClass().getResource("src/main/java/Forms/eye.png")).getImage();
        eye_hide = new ImageIcon(getClass().getResource("src/main/java/Forms/eye_hide.png")).getImage();
